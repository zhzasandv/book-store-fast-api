...
const { data, pending, error } = useFetch<Genre[]>(
...
<template>
  <section class="listing-page">
    ...
    <div v-else-if="error" class="state-message error">Не удалось загрузить жанры.</div>
...
.listing-card {
  ...
  background:
    linear-gradient(160deg, rgba(246, 196, 83, 0.12), rgba(255, 255, 255, 0.03)),
    rgba(13, 14, 23, 0.84);
  border: 1px solid rgba(255, 255, 255, 0.08);
